...
// Campos del aprendiz
$tipo_documento = $_POST["tipo_documento"]; // Nuevo campo
...
$result = $objConsultas->registrarRuta($tipo_documento, $identificacion, $nombre, $apellido, $telefono, $email, $programa, $ficha, $id_usuario, $categoria, $fecha, $id_encargado, $motivo, $estado, $rutaArchivo);
