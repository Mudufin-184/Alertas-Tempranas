      ...
      <li class="nav-item">
        ...
        <ul id="ruta-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            ...
            <i class="fa-solid fa-circle"></i></i><span>Registrar Casos</span>
            </a>
          </li>
          <li>
            <a href="consultarAprendiz.php">
            <i class="fa-solid fa-circle"></i></i><span>Consultar Registros</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="seguimiento-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            ...
            <i class="fa-solid fa-circle"></i></i><span>Consultar Casos Asignados</span>
            </a>
          </li>
        </ul>
      </li><!-- End Ruta de atencion Nav -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card tabla-consultar">
            <div class="card-body tabla-consultar">
              <h5 class="card-title">Consultar Casos Registrados</h5>
